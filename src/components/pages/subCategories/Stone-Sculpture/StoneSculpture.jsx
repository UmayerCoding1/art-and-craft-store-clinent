...
const StoneSculpture = ({craftData}) => {
    return (
        <div>
            <div className='md:grid grid-cols-4 gap-4'> 
              {
                craftData.map(item => {
                    ...
                    return([
                        <div key={item._id} className="border-2 mb-8 rounded-lg h-[50vh]  md:h-[30rem] p-2 mt-4 ">
                        ...
                        <div>
                          ...
                          <div className="flex items-center justify-center mt-3 mb-2">
                              <button className="btn bg-orange-400 hover:bg-orange-400 text-white">View Details</button>
                          </div>
                        </div>
                      </div>
                    ])
...
StoneSculpture.propTypes = {
    craftData:PropTypes.array
}

export default StoneSculpture;